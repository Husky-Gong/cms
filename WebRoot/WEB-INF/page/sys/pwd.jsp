...
<body>
	<form class="layui-form layui-form-pane" style="margin-left: 30px;margin-top: 30px">
		<div class="layui-form-item">
			<label class="layui-form-label" style="width:250px;height:38px;">Old password</label>
			<div class="layui-input-inline">
				<input type="text"  name="password" class="layui-input" lay-verify="required" lay-reqText="Input new password"/>
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label" style="width:250px;height:38px;">New password</label>
			<div class="layui-input-inline">
				<input type="text"  name="newPassword" class="layui-input" lay-verify="required" lay-reqText="Input new password"/>
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label"  style="width:250px;height:38px;">Confirm new password</label>
			<div class="layui-input-inline">
		...
		<div class="layui-form-item"">
			<div class="layui-input-inline" style="margin-left: 50px;margin-top: 30px;">
				<button type="button" class="layui-btn layui-btn-fluid" lay-submit lay-filter="submitBtnFilter"><i class="layui-icon layui-icon-ok"></i>Confirm</button>
				<br></br>
				<button type="button" class="layui-btn layui-btn-fluid"><i class="layui-icon layui-icon-refresh-1"></i>Reset</button>
			</div>
		</div>
	</form>
